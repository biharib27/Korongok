...
while True:
    ...
    if int(koordinata.split("K")[0])>=1 and int(koordinata.split("K")[0])<=8 and int(koordinata.split("K")[1])>=1 and int(koordinata.split("K")[1])<=8 and koordinata not in korongok:
